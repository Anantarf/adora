...
export default async function LoginPage() {
  ...
  return (
    <main className="min-h-screen flex items-center justify-center relative overflow-hidden bg-page-dark px-4 pt-20 pb-6 sm:py-6">
      <Starfield />
      <Link href="/" className="absolute top-4 left-4 sm:top-5 sm:left-5 z-20 skew-box bg-white/10 border-2 border-white/20 text-white px-4 py-2 hover:bg-brand-yellow hover:text-black hover:border-black transition-all shadow-none hover:shadow-[4px_4px_0px_#000] group">
