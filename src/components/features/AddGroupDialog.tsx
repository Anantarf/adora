    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription className="text-sm font-medium tracking-wide">Masukkan rincian grup latihan untuk memisahkan Batch / Kategori usia siswa.</DialogDescription>
        </DialogHeader>
