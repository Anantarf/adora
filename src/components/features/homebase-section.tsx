    ...
    <section className="py-20 bg-background">
      <div className="container mx-auto px-4">
        ...
        <p className="text-center text-foreground/60 mb-16 text-lg">
          Pilih lokasi yang paling dekat dengan Anda
        </p>
          ...
          {homebases.map((homebase) => (
            ...
            >
              ...
              <Link
                ...
                className="inline-block bg-primary text-white px-8 py-3 rounded font-bold hover:bg-primary/80 transition-all duration-300 transform hover:scale-105"
              >
