    ...
    <AlertDialog open={open} onOpenChange={onOpenChange}>
      <AlertDialogContent className="sm:max-w-md bg-card border-border/50">
        <AlertDialogHeader>
          ...
          <AlertDialogDescription className="text-sm text-muted-foreground">Kelompok yang dihapus tidak bisa dikembalikan.</AlertDialogDescription>
        </AlertDialogHeader>
        ...
        <div className="py-6 flex flex-col gap-4">
          ...
          <div className="p-4 rounded-lg bg-amber-500/10 border border-amber-500/20 flex gap-4 items-start">
            ...
            <p className="text-xs font-medium text-muted-foreground">
              Menghapus kelompok akan mengubah status pemain di dalamnya menjadi <span className="font-bold underline">tidak memiliki kelompok</span>. Data pemain tidak akan dihapus.
            </p>
          </div>
        </div>
