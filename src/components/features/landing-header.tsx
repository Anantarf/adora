...
export function LandingHeader() {
  ...
  return (
    <header className="fixed top-0 left-0 z-50 w-full border-b border-white/10 bg-page-dark/90 backdrop-blur-xl">
      ...
      <div className={`fixed inset-0 z-40 md:hidden transition-opacity duration-300 ${open ? "opacity-100 pointer-events-auto" : "opacity-0 pointer-events-none"}`} onClick={() => setOpen(false)} aria-hidden="true">
