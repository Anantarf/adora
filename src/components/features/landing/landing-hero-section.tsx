      ...
      <div className="relative z-20 container mx-auto px-4 flex flex-col items-center text-center">
        <FadeIn delay={0.1} direction="up">
          <div className="inline-block skew-box bg-brand-yellow px-3 py-1.5 sm:px-4 md:px-8 md:py-3 mb-6 md:mb-8 border-b-4 border-r-4 border-black shadow-lg mx-2 max-w-full">
            <span className="unskew-content block font-heading font-black uppercase text-black text-[10px] sm:text-xs md:text-sm tracking-wide md:tracking-[0.16em] pr-1 md:pr-2 leading-tight sm:whitespace-nowrap">PENDAFTARAN DIBUKA {registrationYearText}</span>
          </div>
        </FadeIn>

        <FadeIn delay={0.2} direction="up">
          <h1 className="font-heading font-black text-[clamp(2rem,12vw,4.5rem)] md:text-7xl tracking-normal sm:tracking-tight uppercase mb-6 leading-[0.98] sm:leading-tight text-white drop-shadow-2xl italic py-2 text-balance max-w-5xl">
        ...
        <FadeIn delay={0.3} direction="up">
          <p className="max-w-2xl text-sm sm:text-base md:text-lg text-white mb-8 md:mb-10 leading-relaxed font-medium drop-shadow-md bg-black/30 p-4 md:p-5 rounded-2xl backdrop-blur-sm border border-white/10 text-pretty">
        ...
        <FadeIn delay={0.4} direction="up">
          <Link
            href="/register"
            className="inline-flex skew-box bg-linear-to-r from-brand-orange to-orange-700 hover:from-brand-yellow hover:to-brand-orange text-white hover:text-black font-black px-7 py-3.5 sm:px-8 sm:py-3 md:px-10 md:py-4 transition-all text-sm md:text-xl uppercase tracking-wide md:tracking-widest hover:scale-110 shadow-[4px_4px_0px_#000] md:shadow-[6px_6px_0px_#000] border-2 border-black group"
          >
