      ...
      <div className="relative z-20 container mx-auto px-4 flex flex-col items-center text-center">
        <FadeIn delay={0.1} direction="up">
          <div className="inline-block skew-box bg-brand-yellow px-3 py-1.5 sm:px-4 md:px-8 md:py-3 mb-6 md:mb-8 border-b-4 border-r-4 border-black shadow-lg mx-2 max-w-full">
            <span className="unskew-content block font-heading font-black uppercase text-black text-[10px] sm:text-xs md:text-sm tracking-wide pr-1 md:pr-2 leading-tight sm:whitespace-nowrap">REGISTRASI {registrationYearText}</span>
          </div>
        </FadeIn>
        ...
        <FadeIn delay={0.3} direction="up">
          <p className="text-body-lg max-w-2xl text-white mb-8 md:mb-10 leading-relaxed drop-shadow-md bg-black/30 p-4 md:p-5 rounded-2xl backdrop-blur-sm border border-white/10 text-pretty mx-auto">
