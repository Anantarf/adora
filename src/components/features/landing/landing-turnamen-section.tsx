          ...
          <div className="grid lg:grid-cols-2 gap-5 lg:gap-8 items-center bg-black/40 backdrop-blur-md border border-white/10 p-4 sm:p-5 md:p-10 rounded-card-lg shadow-2xl">
            <div className="flex flex-col items-center lg:items-start text-center lg:text-left gap-4 md:gap-8">
              <div className="w-full">
                ...
                <ul className="text-left space-y-2 md:space-y-3 text-white">
                  <li className="flex items-start gap-3 md:gap-4 bg-white/5 p-3 md:p-4 rounded-2xl border border-white/10 hover:border-brand-orange transition-colors">
                    ...
                    <div>
                      <strong className="text-brand-yellow font-black text-xl tracking-wide uppercase block mb-1">ASBC</strong>
                  ...
                  <li className="flex items-start gap-3 md:gap-4 bg-white/5 p-3 md:p-4 rounded-2xl border border-white/10 hover:border-brand-orange transition-colors">
                    ...
                    <div>
                      <strong className="text-brand-yellow font-black text-xl tracking-wide uppercase block mb-1">ABCC</strong>
                      <span className="text-white/80 text-body leading-snug">Adora Basketball Club Championship (ABCC), kompetisi seru antar klub basket.</span>
                    </div>
                  </li>
                </ul>
              </div>
              ...
              <a
                ...
                className="hidden lg:inline-flex skew-box items-center gap-2 bg-transparent border-4 border-brand-yellow text-brand-yellow hover:bg-brand-yellow hover:text-black px-6 py-3 font-black uppercase tracking-wide text-xs transition-all hover:scale-105 shadow-[4px_4px_0px_#000]"
              >
